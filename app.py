...
def home():
    return jsonify({
        ...
        'status': 'running',
        'version': APP_VERSION,
        'description': 'ACEest Fitness v1.1 - Client profiles with calorie calculation & adherence tracking',
        'features': [
            '3 fitness programs (FL / MG / BG)',
            'Client profile: name, age, weight',
            'Calorie estimation (weight x program factor)',
        ...
        'endpoints': {
            ...
            'POST /add-client': 'Add client with calorie calc',
...
def add_client():
    try:
        ...
        # v1.1: calorie calculation is the key new feature
